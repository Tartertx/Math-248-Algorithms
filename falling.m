...
% time = the array for making the plot, specifically the X axis
% height = the height at time t of the ball (for the plot)
% all of the variables in the Newton function have been left the same
...
function falling()
    ...
    fprintf('\nThe estimated number of seconds it takes the ball to hit the ground will be: %4.3f\n',newtonTable{3,2});
